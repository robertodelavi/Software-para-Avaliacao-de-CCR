...
echo '<!DOCTYPE html>';
	...
	echo '<div id="cssmenu">
		...
		<div id="body_background">
			...
			<div id="title_text">Dental Implant</div>
			<div id="treatment">A dental implant is a "root" device, usually made of titanium, used in dentistry to support restorations that resemble a tooth or group of teeth to replace missing teeth.
				...
				Dental implants can be used to support a number of dental prostheses, including crowns, implant-supported bridges or dentures.[1] They can also be used as anchorage for orthodontic tooth movement. The use of dental implants permits undirectional tooth movement without reciprocal action.</div>
