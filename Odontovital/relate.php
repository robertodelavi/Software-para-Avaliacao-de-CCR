...
echo '<!DOCTYPE html>';
	...
	echo '<div id="cssmenu">
			...
			if (isset($_GET['sucess']) && $_GET['sucess'] == 1){
				echo '<div id="message_signup_type"> <br/><a class="optionLink" href="relate.php?sucess=0&error=0">Relate other treatments and patients</a>&nbsp&nbsp&nbsp or &nbsp&nbsp&nbsp<a class="optionLink" href="restricted.php">Go to Restricted Area</a></div>';
			}else if(isset($_GET['error']) && $_GET['error'] == 1){
				echo '<div id="message_signup_type" style="color:red">*CPF not found</div>';
				echo '<div id="message_signup_type"> <br/>Relate Treatments to Patients:</div>
					<form action="relating.php" method="POST" onSubmit="return test_relate()">
						<label class="loginDescr">*Patient(CPF):</label><input type="text" name="patient" class="loginField" value="'.@$_SESSION['patient'].'"/>
						<div id="error1"> *The CPF of the patient is required</div>
						<label class="loginDescr">*Treatment:</label><input type="text" name="treatment" class="loginField" value="'.@$_SESSION['treatment'].'"/>
						<div id="error2"> *The treatment is required</div>
