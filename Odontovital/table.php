...
echo '<!DOCTYPE html>';
	...
	echo '<div id="cssmenu">
			...
			$result = mysql_query('SELECT * FROM type_treatment');
			while ($rows = mysql_fetch_assoc($result)){
				echo '<div id="background-table">'.$rows["cod"].'</div>
				<div id="background-table">'.$rows["name"].'</div>
				<div id="background-table">'.$rows["cost"].'</div>
				<div id="background-table">'.$rows["doctor"].'</div>';
			}
			echo '</div>';
