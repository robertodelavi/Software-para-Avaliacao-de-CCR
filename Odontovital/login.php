	...
	echo '<div id="cssmenu">
			<ul>
				...
				<li class="has-sub"><a href="#"><span>Professional</span></a>
					<ul>
						<li><a href="#"><span>Cristiano Demartini</span></a></li>
						<li><a href="#"><span>Avner L. Bertollo</span></a></li>
						<li><a href="#"><span>Laudifer Paimel</span></a></li>
					</ul>
				</li>
			...
			<div id="body_background">
					<div id="title_login">
						&nbsp&nbsp&nbspLogin to Odontovital
					</div>
					<div id="form_login">';
					...
					echo'<div id="login">
						<form action="logging.php" method="POST">
							...
							<div id="message_login"> Please enter your account\'s email and password</div>
							<button type="submit" name="submit" value="submit" id="button_login">Login</button>
							<div id="signup_link">or &nbsp <a class = "optionLink" href="signup.php">Sign Up</a></div>
						</form>
					</div>
				</div>
