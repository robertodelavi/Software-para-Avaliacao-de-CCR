...
echo '<!DOCTYPE html>';
	...
	echo '<div id="cssmenu">
		...
		<div id="body_background">
			...
			<div id="title_text">Oral and Maxillofacial Surgery</div>
			<div id="treatment">Oral and maxillofacial surgery is surgery to treat many diseases, injuries and defects in the head, neck, face, jaws and the hard and soft tissues of the oral (mouth) and maxillofacial (jaws and face) region. It is an internationally recognized surgical specialty. In some countries, including the United States, it is a recognized specialty of dentistry; in others, including the UK, it is recognized as a medical specialty.</div>
